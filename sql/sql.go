...
// 2018-08-30 19:21:49.959365404 +0300 MSK m=+0.001239469
...
`,
	"schema_version_18": `create table countries (
    id bigserial not null,
    name text not null,
    primary key (id),
...
create index headlines_title_idx on headlines using btree(title);`,
	"schema_version_19": `create table alerts (
     id bigserial not null,
...
var SqlMapChecksums = map[string]string{
	...
	"schema_version_18": "1231300c8d3ff5394133839e651575c1de0ea609f53bc75a743ee2026effee7b",
	"schema_version_19": "6a50231c3c0456ae07e41073a38d45792b34ffd5da5ff518d93380ee3b1b7f31",
