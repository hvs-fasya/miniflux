...
// 2018-05-09 12:35:03.490710603 +0300 MSK m=+0.004761589
...
{{ end }}
`,
	"feed_filters": `{{ define "title"}}Filters - test{{ end }}
...
{{else}}
    ...
    <h3>Current filter: {{ .current.FilterName }}</h3>
    <div class="items">
...
var templateViewsMapChecksums = map[string]string{
	...
	"feed_filters":        "b0beaf273aa6a3cb90a479f7a515fad955368786784b96617fbdab1f9732ce6b",
