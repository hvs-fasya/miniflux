...
// 2018-05-21 18:57:34.911890862 +0300 MSK m=+0.006171264
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
            <h3>VisaDB - NEWS</h3>
            <label class = "mdl-checkbox mdl-js-checkbox" for = "worldwide">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
            ...
            <a href="#changes" class="mdl-layout__tab">Visa Changes</a>
        </div>
    </header>
...
var templateNewsCommonMapChecksums = map[string]string{
	"layout": "561a499879fcbd7771b0a833cf892fd368be955e730c3ba0ed2022e23fac7c68",
}
