...
// 2018-07-08 22:56:30.288826901 +0300 MSK m=+0.006022862
...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="VisaDB">
    ...
    {{ end }}
    <title>{{template "title" .}} - VisaDB</title>
    {{ if .user }}
...
<body data-entries-status-url="{{ route "updateEntriesStatus" }}">
    ...
    <header class="header">
        <nav>
            <div class="logo">
                <a href="{{ route "unread" }}">Visa<span>DB</span></a>
            </div>
            <ul>
                ...
                <li {{ if eq .menu "filters" }}class="active"{{ end }} title="{{ t "Keyboard Shortcut: %s" "g f s" }}">
        ...
        <div id="modal-left">
            ...
            <div class="keyboard-shortcuts">
                ...
                <ul>
                    ...
                    <li>{{ t "Go to filters" }} = <strong>g + f + s</strong></li>
...
var templateCommonMapChecksums = map[string]string{
	...
	"layout":           "ec96887f19c398f773248eca70c5d54a70ef7be88ff75d522356a88daab0943f",
	"pagination":       "210de3a190506591dd81f0d48062549a3f5533ebd8ab3bd595b519e9e3172aa2",
}
