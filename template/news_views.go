...
// 2018-07-08 17:41:19.710782449 +0300 MSK m=+0.014903699
...
<div class="mdl-layout__tab-panel" id="security">
    ...
    {{/*<div id="map" style="position: relative; width: 750px; height: 600px;"></div>*/}}
</div>
<!-- VISA CHANGES -->
...
{{ end }}`,
	"news_security": `{{ define "news_security"}}
        ...
        <div class="mdl-card mdl-cell mdl-cell--12-col">
            <div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                        <span class="mdl-list__item-primary-content">
                            <span class="mdl-layout-spacer"></span>
                        {{noescape (proxyFilter .disasters ) }}
                        </span>
                </div>
            </div>
        </div>
...
var templateNewsViewsMapChecksums = map[string]string{
	"home":     "cd3bce11e8730a7e70d6624a5aaec6095648132e2833c7049cdea19325b793d6",
	...
	"security": "8d4c41cfb7af9e6a80ce389099c086a70d297a1cc7b7d2671f5c6d0a94dd2c5b",
	"sources":  "37878c8c51f13928e468057b7c88e8a0183a3c69094c8e702ac583d7edabd31d",
	"travel":   "787ab81253c542907c2570d12ce6ed298ff61f97272dc897103ac1002ca4935b",
	"visa":     "8b43d43c44a1b1d6931e444982f146b4e3dc824e04e20901fd31be0f412958ce",
}
