...
// 2018-06-24 18:19:32.876792111 +0300 MSK m=+0.010381146
...
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
    <p> {{ .country }}</p>
    <div>{{noescape (proxyFilter .doc) }}</div>
</section>
...
var templateNewsViewsMapChecksums = map[string]string{
	...
	"security": "59477d4fc3f7388cf8f0be11ffc84f9b7a73a3f1dfded248e05b9a43e0def368",
